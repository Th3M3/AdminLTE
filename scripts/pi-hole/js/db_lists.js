...
function updateTopClientsChart() {
  ...
  $.getJSON("api_db.php?topClients&from=" + from + "&until=" + until, function(
    data
  ) {
...
function updateTopDomainsChart() {
  ...
  $.getJSON("api_db.php?topDomains&from=" + from + "&until=" + until, function(
    data
  ) {
    // Clear tables before filling them with data
    $("#domain-frequency td")
...
function updateTopAdsChart() {
  ...
  $.getJSON("api_db.php?topAds&from=" + from + "&until=" + until, function(
    data
  ) {
    // Clear tables before filling them with data
    $("#ad-frequency td")
